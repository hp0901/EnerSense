...
export default function MyPlanPage() {
  ...
  return (
    <div className="w-full bg-gradient-to-br from-gray-400 to-yellow-150 border border-indigo-200 mx-auto px-6 py-16">
      ...
      <div className="bg-gradient-to-br from-indigo-300 to-yellow-200 border border-indigo-200 rounded-2xl p-8 mb-10">
      ...
      <div className="bg-gradient-to-br from-pink-200 to-blue-200 border border-indigo-200 rounded-2xl p-8">
